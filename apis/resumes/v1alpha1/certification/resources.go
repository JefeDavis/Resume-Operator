...
// sampleCertification is a sample containing all fields
const sampleCertification = `apiVersion: resumes.jefedavis.dev/v1alpha1
kind: Certification
metadata:
...
// sampleCertificationRequired is a sample containing only required fields
const sampleCertificationRequired = `apiVersion: resumes.jefedavis.dev/v1alpha1
kind: Certification
metadata:
  name: certification-sample
  namespace: default
...
func Sample(requiredOnly bool) string {
	if requiredOnly {
		return sampleCertificationRequired
	}
...
func Generate(
	workloadObj resumesv1alpha1.Certification,
...
func GenerateForCLI(workloadFile []byte, collectionFile []byte) ([]client.Object, error) {
	var workloadObj resumesv1alpha1.Certification
...
var CreateFuncs = []func(
	*resumesv1alpha1.Certification,
	*resumesv1alpha1.Profile,
) ([]client.Object, error){
	CreateConfigMapResumeCert,
}
...
func ConvertWorkload(component, collection workload.Workload) (
	...
	*resumesv1alpha1.Profile,
	...
	p, ok := component.(*resumesv1alpha1.Certification)
	if !ok {
		return nil, nil, resumesv1alpha1.ErrUnableToConvertCertification
	}
