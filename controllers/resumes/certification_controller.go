...
func NewCertificationReconciler(mgr ctrl.Manager) *CertificationReconciler {
	return &CertificationReconciler{
		Name:         "Certification",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("Certification-Controller"),
		FieldManager: "Certification-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("resumes").WithName("Certification"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}
...
// +kubebuilder:rbac:groups=resumes.jefedavis.dev,resources=certifications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=resumes.jefedavis.dev,resources=certifications/status,verbs=get;update;patch
...
func (r *CertificationReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *CertificationReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &resumesv1alpha1.Certification{}
...
func (r *CertificationReconciler) SetCollection(component *resumesv1alpha1.Certification, req *workload.Request) error {
...
func (r *CertificationReconciler) GetCollection(
	component *resumesv1alpha1.Certification,
	...
	var collectionRef resumesv1alpha1.CertificationCollectionSpec
...
func (r *CertificationReconciler) EnqueueRequestOnCollectionChange(req *workload.Request) error {
	if len(r.Watches) > 0 {
...
func (r *CertificationReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	resourceObjects := []client.Object{}

	component, collection, err := certification.ConvertWorkload(req.Workload, req.Collection)
	if err != nil {
		return nil, err
	}

	// create resources in memory
	resources, err := certification.Generate(*component, *collection)
	if err != nil {
		return nil, err
	}
...
func (r *CertificationReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *CertificationReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *CertificationReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *CertificationReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *CertificationReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *CertificationReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *CertificationReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *CertificationReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.CertificationCheckReady(r, req)
}

// Mutate will run the mutate function for the workload.
func (r *CertificationReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.CertificationMutate(r, req, object)
}
...
func (r *CertificationReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	baseController, err := ctrl.NewControllerManagedBy(mgr).
		...
		For(&resumesv1alpha1.Certification{}).
		Build(r)
	if err != nil {
